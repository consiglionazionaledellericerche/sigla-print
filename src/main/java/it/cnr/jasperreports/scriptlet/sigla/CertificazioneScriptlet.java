...
public class CertificazioneScriptlet extends JRDefaultScriptlet {
    ...
    public void beforeReportInit() throws JRScriptletException {
        ...
        try {
            ...
            cs.setObject(1, getParameterValue("esercizio"));
            cs.setObject(2, getParameterValue("ti_cert"));
            cs.setObject(3, getParameterValue("cd_anag"));
            cs.setObject(4, getParameterValue("nota"));
            cs.executeQuery();
        } catch (Throwable e) {
