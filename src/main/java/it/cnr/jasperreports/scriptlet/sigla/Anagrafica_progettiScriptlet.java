...
public class Anagrafica_progettiScriptlet extends JRDefaultScriptlet {
    ...
    public void beforeReportInit() throws JRScriptletException {
        ...
        try {
            ...
            cs.setObject(2, getParameterValue("progetto"));
            cs.setObject(3, getParameterValue("livello"));
            cs.setObject(4, getParameterValue("stato"));
            cs.setObject(5, getParameterValue("esercizio"));
            cs.setObject(6, getParameterValue("fase"));
            cs.executeQuery();
        } catch (Throwable e) {
